...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
		...
		<li class="active"><a href="<?php echo base_url('banner');?>"><?php echo lang('banner_list');?></a></li>
        <li ><a href="<?php echo base_url('banner/viewbanner');?>/<?php echo $this->uri->segment(3);?>">Banner</a></li>
        <li class="active"><?php echo lang('update_banner');?></li>
      </ol>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" action="<?php echo base_url('banner/editviewBanner/'.$this->uri->segment(3).'/'.$fetchmodule['resultset']->id);?>" enctype="multipart/form-data" id="frm_subadmin">
				...
				<div class="box-body">
					...
					<div class="form-group">
					  ...
					  <img src="<?php echo base_url();?>/images/banner/<?php echo $fetchmodule['resultset']->banner_image;?>" width="200px" />
					</div>
					</div>
