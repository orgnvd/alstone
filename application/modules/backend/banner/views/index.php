        ...
        <div class="col-xs-12">
            ...
            <div class="box-header" >
				<ol class="breadcrumb bgnone">
					...
					<a href="<?php echo base_url('banner/addBanner');?>">
					<button type="submit" class="btn btn-primary pull-right"><?php echo lang('add_banner');?></button>
				</a>
				</ol>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <!--  <th><?php echo lang('banner_country');?></th>
				...
				<?php if(!empty($module_list)){ 
					...
					<tr>
						...
						<!--<td><?php 
						foreach($module_list[$key]['country'] as $country)
						{
							echo $country['country_name']." (" . $country['language_name']. ")<span>,</span> " ;
						}
						?></td>-->
						...
						<td>
						<a class="btn btn-success" data-toggle="tooltip" data-placement="top" title="" href="<?php echo base_url() . "banner/editBanner/" . $value['id']; ?>" style="padding: 0px 4px;" data-original-title="Edit Banner"><i class="fa fa-edit"></i></a>  
						<!--<a class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="" href="<?php echo base_url() . "banner/deleteBanner/" . $value['id']; ?>" style="padding: 0px 4px;" data-original-title="Delete Banner" onclick="return confirm('Are you sure? you want to delete.')"><i class="fa fa-trash"></i></a> 
						<a class="btn btn-success" data-toggle="tooltip" data-placement="top" title="" href="<?php echo base_url() . "banner/viewbanner/" . $value['id']; ?>" style="padding: 0px 4px;" data-original-title="View banner"><i class="fa fa-eye"></i></a>
							-->					
						</td>
					</tr>
                <?php $i++; } }?>
  ...
  $(document).ready(function() {
        ...
        $(document).on('click', '.status_active', function() {
            ...
            if (r == true) {
                ...
                $.post('<?php echo base_url() ?>banner/ajax_getbannerstatus', {'static_page_id': static_page_id, 'status': status}, function(data) {
