      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" name="business_category" id="b_category" action="<?php echo base_url('category/process/'.$this->uri->segment(3));?>" enctype="multipart/form-data">
				<div class="box-body">
					...
					<div class="form-group">
					  ...
					  <input type="text" class="form-control" id="b_cate_name" name="b_cate_name" placeholder="Category name" value="<?php echo $edit_business['resultSet']->business_name;?>">
					...
					<div class="form-group">
						...
						<div class="input-group" style="width:30%;">
							...
							<?php
								$image = $edit_business['resultSet']->b_cate_image;
								if(!$image){
									$image = "noimage.jpg";
								}
							?>
						...
						<img src="<?php echo base_url('images/category/'.$image);?>" style="padding: 6px;">
        ...
        <div class="col-md-12 column">
            <table class="table table-bordered table-hover" id="table_id">
                ...
                <tbody>
				<?php if(!empty($edit_business['resultSet2'])){
						$i=0;
						foreach($edit_business['resultSet2'] as $value){ ?>
