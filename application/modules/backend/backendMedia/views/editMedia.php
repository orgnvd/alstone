    ...
    <section class="content">
      <div class="row">
        ...
        <li class="active"><?php echo lang('add_product');?></li>
            ...
            <!-- form start -->
			<?= validation_errors(); ?>
             <form method="post" action="<?php echo base_url('backendMedia/update/' . $updated->id);?>" enctype="multipart/form-data" id="frm_subadmin">
				<div class="box-body">
					<div class="form-group">
					  <label for=""><?php echo lang('media_title');?>*</label>
					  <input type="text" class="form-control" id="media_title" name="media_title" placeholder="Media Title" value="<?php echo $updated->media_title; ?>">
					</div>
					
					<div class="form-group">
					  <label for=""><?php echo lang('media_slug');?>*</label>
					  <input type="text" class="form-control" id="media_slug" name="slug" placeholder="Media Slug" value="<?php echo $updated->slug; ?>">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					  ...
					  <input type="text" class="form-control datepicker" id="datefrom" name="date" value="<?php echo $updated->date ;?>">
					</div>
					<div class="form-group">
					  <label for=""><?php echo lang('media_desc');?>*</label>
						<textarea id="media_desc" name="media_description" class="form-control ckeditor">
						<?php echo $updated->media_description; ?></textarea>
					</div>
					
					<div class="form-group">
					  <label for=""><?php echo lang('media_image');?></label>
					  <input name="media_image" type="file" id="media_image" value="<?php echo $updated->media_image; ?>" multiple>
					   <input type="hidden" name="old" value="<?php echo $updated->media_image; ?>">
					</div>
					
					<?php if(!empty($updated)) :?>
						<div class="form-group">
							<img src="<?php echo base_url('images/media/');?><?php echo $updated->media_image;?>" id="image<?php echo $updated->media_image;?>" style="width:100px;">
						</div>
						<?php else : ?>
					...
					<div class="form-group">
					  ...
					  <input type="text" maxlength="30" class="form-control" id="meta_title" name="meta_title" placeholder="Media Meta Title" value="<?php echo $updated->meta_title;?>">
					</div>
					<div class="form-group">
					  <label for=""><?php echo lang('media_meta_keyword');?>*</label>
					  <input type="text" maxlength="50" class="form-control" id="meta_keyword" name="meta_keyword" placeholder="Media Meta Keyword" value="<?php echo $updated->meta_keyword;?>">
					</div>
					<div class="form-group">
					  <label for=""><?php echo lang('media_meta_desc');?>*</label>
					  <input type="text" maxlength="165" class="form-control" id="meta_description" name="meta_description" placeholder="Media Meta Description" value="<?php echo $updated->meta_description;?>">
